...
const K = ({ isOpen: a, returnTabId: r, onClose: i }) => {
  const o = e();
          ...
          n.jsxs("div", {
            ...
            children: [
              ...
              n.jsx("p", {
                ...
                children: n.jsx(t, {
                  defaultMessage:
                    "Claw needs microphone access to hear your voice narration while you demonstrate workflows. When prompted, select <strong>Allow while visiting the site</strong> to enable voice narration.",
                  id: "C8CF1Igl7Q",
                  values: {
                    strong: (e) =>
                      n.jsx("span", {
...
function cpGithubUpdateInterpolate(e, t) {
  return String(e || "").replace(/\{(\w+)\}/g, (e, a) =>
    t && t[a] != null ? String(t[a]) : "",
  );
}
...
const __cpOptionsSettingsTabTokens = [
  __cpOptionsSettingsTabTokenPermissions,
  __cpOptionsSettingsTabTokenPrompts,
  __cpOptionsSettingsTabTokenOptions,
  __cpOptionsSettingsTabTokenInternal,
];
const __cpOptionsSettingsTabDefaultToken =
  __cpOptionsSettingsTabTokenPermissions;
...
function cpGetSettingsTabFromHash(e) {
  const t = String(e || window.location.hash || "")
    .replace(/^#/, "")
    .split("?")[0];
  return __cpOptionsSettingsTabWhitelist.includes(t)
    ? t
    : __cpOptionsSettingsTabDefaultToken;
}
function cpGetOptionsSubviewFromHash(e) {
  const t = String(e || window.location.hash || "").replace(/^#/, "");
  const a = t.split("?");
  if (
    (a[0] || __cpOptionsSettingsTabDefaultToken).toLowerCase() !==
    __cpOptionsSettingsTabTokenOptions
  ) {
    return "";
  }
  const s = String(
    new URLSearchParams(a[1] || "").get(__cpOptionsHashParamProviderKey) || "",
  )
    .trim()
    .toLowerCase();
  if (
    s === __cpOptionsHashParamTruthyValue ||
    s === __cpOptionsProviderSubviewToken
  ) {
    return __cpOptionsProviderSubviewToken;
  }
  if (
    s === __cpOptionsSessionSubviewToken ||
    s === __cpOptionsHashParamProviderAliasSessions
  ) {
    return __cpOptionsSessionSubviewToken;
  }
  if (
    s === __cpOptionsPromptSubviewToken ||
...
const cpGithubUpdateSection = () => {
  ...
  const w = async (e) => {
    try {
      ...
      v("error");
      b(
        cpGithubUpdateInterpolate(h.checkFailed, {
  ...
  const M = async () => {
    ...
    if (!e) {
      v("error");
      b(
        cpGithubUpdateInterpolate(h.openReleaseFailed, {
          message: h.unknown,
        }),
      );
    }
  ...
  const N = async () => {
    ...
    if (!e) {
      v("error");
      b(
        cpGithubUpdateInterpolate(h.openDownloadFailed, {
          message: h.unknown,
        }),
      );
    }
        ...
        n.jsxs("div", {
          ...
          children: [
            ...
            n.jsxs("div", {
              ...
              children: [
                A(h.currentVersion, j.currentVersion || h.unknown),
                A(h.latestVersion, j.latestVersion || h.latestReady),
                A(
                  h.lastCheckedAt,
                  j.lastCheckedAt ? i(j.lastCheckedAt, p) : h.neverChecked,
                ),
              ],
            }),
            n.jsxs("div", {
  ...
  return n.jsxs("div", {
    ...
    children: [
      ...
      n.jsx("p", {
        ...
        children: n.jsx(t, {
          defaultMessage:
            "Configure the keyboard shortcut used to open Claw in Chrome.",
          id: "CcjsWsUTac",
        }),
      }),
      n.jsxs("div", {
...
const Q = ({ children: e, className: t, narrow: a }) =>
  n.jsx("main", {
    className: c(
...
const te = () => {
  ...
  const __cpOptionsPermissionManagerContract =
  ...
  const __cpOptionsAutoApproveAllPermissionRequestsStorageKey =
    __cpOptionsPermissionManagerContract.AUTO_APPROVE_ALL_REQUESTS_STORAGE_KEY ||
    "autoApprovePermissionRequests";
  const __cpOptionsLastPermissionModePreferenceStorageKey =
    __cpOptionsPermissionManagerContract.LAST_PERMISSION_MODE_PREFERENCE_STORAGE_KEY ||
    "lastPermissionModePreference";
  const [
    __cpOptionsAutoApproveAllPermissionRequests,
    __cpSetOptionsAutoApproveAllPermissionRequests,
  ] = m(__cpOptionsAutoApproveAllPermissionRequestsStorageKey, false);
  const { analytics: p } = h();
  ...
  const __cpHandleOptionsAutoApproveToggle = s.useCallback(
    async (e) => {
      await __cpSetOptionsAutoApproveAllPermissionRequests(e);
      await chrome.storage.local.set({
        [__cpOptionsLastPermissionModePreferenceStorageKey]: e
          ? "skip_all_permission_checks"
          : "ask",
      });
      p?.track?.("claude_chrome.settings.permission_auto_approve_toggled", {
        enabled: e,
      });
    },
    [
      __cpSetOptionsAutoApproveAllPermissionRequests,
      __cpOptionsLastPermissionModePreferenceStorageKey,
      p,
    ],
  );
  const g = (e) =>
    e.scope.type === "domain_transition"
        ...
        n.jsxs("div", {
          ...
          children: [
            ...
            n.jsx("p", {
              ...
              children: n.jsx(t, {
                defaultMessage:
                  "Choose whether Claw should ask before future browser permission requests.",
                id: "gJsw6oh4TA",
              }),
            }),
            n.jsxs("div", {
                ...
                n.jsxs("div", {
                  ...
                  children: [
                    ...
                    n.jsx("div", {
                      className: "text-text-400 font-base-sm mt-1",
                      children:
                        __cpOptionsAutoApproveAllPermissionRequests === true
                          ? n.jsx(t, {
                              defaultMessage:
                                "Future browser permission requests will be approved automatically until you turn this off.",
                              id: "PQK4NNXwVt",
                            })
                          : n.jsx(t, {
                              defaultMessage:
                                "Claw will keep asking before it browses, clicks, types, or navigates on new sites.",
                              id: "Rr4v7Xc1iT",
                            }),
                    }),
                  ],
                  ...
                  children: [
                    n.jsx("input", {
                      ...
                      checked:
                        __cpOptionsAutoApproveAllPermissionRequests === true,
                      onChange: (e) =>
                        __cpHandleOptionsAutoApproveToggle(
                          e.target.checked,
                        ),
                    }),
                    n.jsx("div", {
            ...
            n.jsx("div", {
              ...
              children: n.jsx(t, {
                defaultMessage:
                  "Turning this on also sets the default permission mode to skip permission checks. You can still revoke individual site permissions below.",
                id: "BvsF9JQ8oT",
              }),
            }),
          ],
        ...
        n.jsxs("div", {
          ...
          children: [
            ...
            n.jsx("p", {
              ...
              children: n.jsx(t, {
                defaultMessage:
                  "You have allowed Claw to take all actions (browse, click, type) on these sites.",
                id: "7W74V502ms",
              }),
            }),
            o
...
const ae = ({ permissions: e, onRevoke: a, formatScope: s }) =>
  n.jsx("div", {
    children: e.map((i, o) =>
      n.jsxs(
        r.Fragment,
...
const se = ({ permissions: e, onRevoke: a, formatScope: s }) =>
  n.jsx("div", {
    children: e.map((i, o) =>
      n.jsxs(
        r.Fragment,
...
const ne = ({ children: e, isActive: t, onClick: a }) =>
  n.jsx("button", {
    onClick: a,
    className: c(
...
function oe({
  ...
  const [y, v] = s.useState(
    (() => {
      ...
      if (t !== -1) {
        if (
          new URLSearchParams(e.substring(t)).get(
            __cpOptionsShortcutsHashParamTabKey,
          ) === __cpOptionsShortcutsTabTokenBrowse
        ) {
  ...
  const E = (e) => {
    ...
    const t = e.specificTime
      ? new Date(`2000-01-01T${e.specificTime}`).toLocaleTimeString("en-US", {
          hour: "numeric",
          minute: "2-digit",
          hour12: true,
        })
  ...
  s.useEffect(() => {
    const __cpOptionsPermissionManagerContract =
      globalThis.__CP_CONTRACT__?.permissionManager || {};
    const __cpOptionsPendingScheduledTaskStorageKey =
      __cpOptionsPermissionManagerContract.PENDING_SCHEDULED_TASK_STORAGE_KEY ||
      T.PENDING_SCHEDULED_TASK;
    C();
    (async () => {
  ...
  return n.jsxs(n.Fragment, {
    children: [
      ...
      n.jsxs("div", {
        className: "space-y-6",
        children: [
          !l && n.jsx(cpKeyboardShortcutCard, {}),
          n.jsxs("div", {
            className: l
              ? "px-6 pt-6 pb-6"
...
function ce() {
  ...
  const { isAuthenticated: a } = E();
  // internal tab（调试/内部）在当前构建中被关闭：保持为 false 以避免暴露额外入口
  const i = false;
  const [o, l] = s.useState("");
  const [d, c] = s.useState(() =>
    cpGetSettingsTabFromHash(window.location.hash),
  );
  const [m, p] = s.useState(false);
  const [u, x] = s.useState();
  const [providerSubview, setProviderSubview] = s.useState(() =>
    cpGetOptionsSubviewFromHash(window.location.hash),
  );
  ...
  const __cpOptionsAccountBootstrapStorageKey =
    __cpOptionsCustomProviderContract.ANTHROPIC_API_KEY_STORAGE_KEY ||
    T.ANTHROPIC_API_KEY;
  ...
  s.useEffect(() => {
    __cpOptionsAccountBootstrapReader(__cpOptionsAccountBootstrapStorageKey)
      .then((e) => {
  ...
  s.useEffect(() => {
    ...
    const e = () => {
      ...
      const [t, a] = e.split("?");
      const s = __cpOptionsSettingsTabWhitelist.includes(t)
        ? t
        : __cpOptionsSettingsTabDefaultToken;
      let n;
      let r = false;
      ...
      if (a) {
        ...
        r =
          e.get(__cpOptionsHashParamRequestMicrophoneKey) ===
          __cpOptionsHashParamTruthyValue;
        const t = e.get(__cpOptionsHashParamReturnTabIdKey);
        if (t) {
          n = parseInt(t, 10);
        }
        const s = String(e.get(__cpOptionsHashParamProviderKey) || "")
          .trim()
          .toLowerCase();
        if (
          s === __cpOptionsHashParamTruthyValue ||
  ...
  const g = (e) => {
    ...
    window.location.hash =
      e === __cpOptionsProviderSubviewToken
        ? __cpOptionsHashFragmentOptionsProvider
        : e === __cpOptionsSessionSubviewToken
        ...
        children: [
          ...
          n.jsxs("div", {
            ...
            children: [
                    ...
                    children: [
                      n.jsx("li", {
                        children: n.jsx(ne, {
                          ...
                          isActive:
                            d === __cpOptionsSettingsTabTokenPermissions,
                          onClick: () =>
                            f(__cpOptionsSettingsTabTokenPermissions),
                          children: n.jsx(t, {
                      ...
                      n.jsx("li", {
                        ...
                        children: n.jsx(ne, {
                          ...
                          isActive:
                            d === __cpOptionsSettingsTabTokenOptions &&
                            providerSubview === __cpOptionsProviderSubviewToken,
                      ...
                      n.jsx("li", {
                        ...
                        children: n.jsx(ne, {
                          ...
                          isActive:
                            d === __cpOptionsSettingsTabTokenOptions &&
                            providerSubview === __cpOptionsSessionSubviewToken,
              ...
              n.jsxs("div", {
                children: [
                  d === __cpOptionsSettingsTabTokenPermissions && n.jsx(te, {}),
                  d === __cpOptionsSettingsTabTokenPrompts && n.jsx(oe, {}),
                  d === __cpOptionsSettingsTabTokenOptions &&
                    n.jsx(J, {
...
a.createRoot(document.getElementById(__cpOptionsRootMountElementId)).render(
  n.jsx(r.StrictMode, {
