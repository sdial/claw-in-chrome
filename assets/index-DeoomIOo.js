...
function s() {
  ...
  function a(p, a) {
    ...
    const l = a.moduloBitLength
      ? Math.pow(2, a.moduloBitLength)
      : Math.pow(2, p);
    const i = a.moduloBitLength
...
function D() {
  ...
  function s(d, l) {
    ...
    for (var r = i(d), v = 0; v < r; ++v) {
      ...
      if (
        (o === a.TRANSITIONAL && n[1] !== "valid") ||
        (o === a.NONTRANSITIONAL && n[1] !== "valid" && n[1] !== "deviation")
      ) {
        s = true;
        break;
      }
  ...
  if (!c) {
    ...
    (function (p) {
      ...
      function b(p) {
        ...
        if (
          (d === 10 ? /[^0-9]/ : d === 16 ? /[^0-9A-Fa-f]/ : /[^0-7]/).test(p)
        ) {
          return m;
        } else {
          return parseInt(p, d);
      ...
      E.prototype["parse hostname"] = E.prototype["parse host"] = function (
        p,
        d,
      ) {
          ...
          m instanceof Buffer
            ...
            : ArrayBuffer.isView(m)
              ...
              : m instanceof ArrayBuffer
                ...
                : m instanceof E
                  ? m[y]
                  : Buffer.from(typeof m == "string" ? m : String(m));
        e += l.length;
        a.push(l);
      }
    }
    ...
    d.on("data", function (d) {
      if (!l && d !== null) {
        if (p.size && m + d.length > p.size) {
          l = true;
          i(
            new C(`content size at ${p.url} over limit: ${p.size}`, "max-size"),
          );
          return;
        }
        m += d.length;
...
function U(p) {
  return (
    typeof p == "object" &&
    typeof p.append == "function" &&
    typeof p.delete == "function" &&
    typeof p.get == "function" &&
    typeof p.getAll == "function" &&
    typeof p.has == "function" &&
    typeof p.set == "function" &&
    (p.constructor.name === "URLSearchParams" ||
      Object.prototype.toString.call(p) === "[object URLSearchParams]" ||
...
function I(p) {
  ...
  if (d === null) {
    ...
    d &&
    typeof d.getLengthSync == "function" &&
    ((d._lengthRetrievers && d._lengthRetrievers.length == 0) ||
      ...
      }
      {
        ...
        if (d != null) {
          ...
          for (const d of p) {
            if (
              typeof d != "object" ||
              typeof d[Symbol.iterator] != "function"
            ) {
  ...
  constructor(p) {
    ...
    this.compress =
      a.compress !== undefined
        ? a.compress
        : p.compress === undefined || p.compress;
        ...
        switch (l.redirect) {
          ...
          case "follow":
            ...
            if (p.statusCode !== 303 && l.body && I(l) === null) {
              ...
              if (
                p.statusCode === 303 ||
                ((p.statusCode === 301 || p.statusCode === 302) &&
                  l.method === "POST")
              ) {
                e.method = "GET";
                e.body = undefined;
