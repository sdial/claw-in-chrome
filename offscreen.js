...
const __cpOffscreenContractMessages =
  globalThis.__CP_CONTRACT__?.messages || {};
const __cpOffscreenContract = globalThis.__CP_CONTRACT__?.offscreen || {};
const __cpOffscreenKeepaliveMessageType =
  __cpOffscreenContractMessages.SW_KEEPALIVE || "SW_KEEPALIVE";
const __cpOffscreenKeepaliveIntervalMs =
  __cpOffscreenContract.KEEPALIVE_INTERVAL_MS || 20000;
const __cpOffscreenMessageTypePlaySound =
  __cpOffscreenContractMessages.OFFSCREEN_PLAY_SOUND || "OFFSCREEN_PLAY_SOUND";
const __cpOffscreenMessageTypeGenerateGif =
  __cpOffscreenContractMessages.GENERATE_GIF || "GENERATE_GIF";
const __cpOffscreenMessageTypeRevokeBlobUrl =
  __cpOffscreenContractMessages.REVOKE_BLOB_URL || "REVOKE_BLOB_URL";
const __cpOffscreenAudioFieldUrl =
  __cpOffscreenContract.AUDIO_FIELD_URL || "audioUrl";
...
const __cpOffscreenGifFieldOptions =
  __cpOffscreenContract.GIF_FIELD_OPTIONS || "options";
const __cpOffscreenGifFieldBlobUrl =
  __cpOffscreenContract.GIF_FIELD_BLOB_URL || "blobUrl";
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  if (message.type === __cpOffscreenMessageTypePlaySound) {
    ...
    const volume =
      message[__cpOffscreenAudioFieldVolume] || __cpOffscreenDefaultVolume;
    playAudioWithWebAudioAPI(message[__cpOffscreenAudioFieldUrl], volume)
      .then(() => {
  ...
  if (message.type === __cpOffscreenMessageTypeGenerateGif) {
    ...
    console.log(
      `[Offscreen] Frames: ${message[__cpOffscreenGifFieldFrames]?.length}`,
    );
    console.log(`[Offscreen] Options:`, message[__cpOffscreenGifFieldOptions]);
    generateGif(
      message[__cpOffscreenGifFieldFrames],
      message[__cpOffscreenGifFieldOptions],
    )
      .then((result) => {
